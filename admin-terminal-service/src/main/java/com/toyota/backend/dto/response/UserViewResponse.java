...
public class UserViewResponse {
    ...
    public static UserViewResponse convertUserViewResponse(User user)
    {
            return UserViewResponse.builder()
                    ...
                    .activeness(user.isActive())
                    .roleList(user.getRoles().stream().map(Role::getName).collect(Collectors.toList()))
                    .build();
    }
    /**
     * Converts a page of User objects into a list of UserViewResponse objects.
     ...
     */
    public static List<UserViewResponse> convertUserListToUserViewResponse(Page<User> users){
